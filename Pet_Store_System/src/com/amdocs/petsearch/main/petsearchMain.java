        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    System.out.print("Pet id (integer Format): ");
                    int petid = scanner.nextInt();
                    System.out.print("Pet Category (String DataType): ");
                    String category = scanner.next();
                    System.out.print("Pet Type (String DataType): ");
                    String type = scanner.next();
                    System.out.print("Color (String DataType: ");
                    String color = scanner.next();
                    System.out.print("Age (integer Format) :");
                    int age = scanner.nextInt();
                    System.out.print("Price (Float DataType) :");
                    float price = scanner.nextFloat();
                    System.out.print("Is Vaccinated (true/false): ");
                    boolean isVaccinated = scanner.nextBoolean();
                    System.out.print("Food Habits (String DatType): ");
                    scanner.nextLine(); // Consume the newline character
				...
				try {
					...
					System.out.println("Pet not found in the given price range");
				}
